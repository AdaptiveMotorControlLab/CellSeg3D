...
project = u'napari-cellseg-annotator'
copyright = u'2015, Cyril Achard'
author = u'Cyril Achard'
...
man_pages = [
    (main_doc, 'napari-cookiecutterplugin_name', u'napari-cellseg-annotator Documentation',
     [author], 1)
]
